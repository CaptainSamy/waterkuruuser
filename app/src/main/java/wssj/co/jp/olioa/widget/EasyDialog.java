...
public class EasyDialog {
    ...
    private void initDialog(final Context context, ILoadMoreListener callback) {
        ...
        mListView = dialogView.findViewById(R.id.listView);
        mListView.setOnLoadMoreListener(callback);
...
//            this.contentView = layout;
    ...
    public EasyDialog setMargin(int left, int top, int right, int bottom) {
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) llContent.getLayoutParams();
