...
import wssj.co.jp.olioa.model.entities.Actions;
import wssj.co.jp.olioa.model.entities.Area;
...
//        Log.d(TAG,"chat item: " + chat.getId() + ", " + chat.getContentType() + ", " + chat.getDate() + ", " + chat.isUser() + ", " + chat.getContent());
        if (chat != null) {
            if (chat.isUser()) {
                return TYPE_USER;
            } else {
