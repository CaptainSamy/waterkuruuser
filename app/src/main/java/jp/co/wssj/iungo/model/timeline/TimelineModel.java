...
public class TimelineModel extends BaseModel {
    ...
    public void getTimeLine(String token, int timelineId, final OnGetTimelineCallback callback) {
        final Request request = APICreator.getTimeline(token, timelineId, new Response.Listener<TimeLineResponse>() {
